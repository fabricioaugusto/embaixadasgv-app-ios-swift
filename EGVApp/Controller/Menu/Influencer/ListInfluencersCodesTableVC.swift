//
//  ListInfluencersCodesTableVC.swift
//  EGVApp
//
...
class ListInfluencersCodesTableVC: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "influencerCodeCell", for: indexPath) as! BasicUserCell
