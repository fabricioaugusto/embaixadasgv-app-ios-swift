//
//  ListCounselorsCodesTableVC.swift
//  EGVApp
//
...
class ListCounselorsCodesTableVC: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "counselorCodeCell", for: indexPath) as! BasicUserCell
